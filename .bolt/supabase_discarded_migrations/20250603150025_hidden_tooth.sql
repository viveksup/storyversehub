/*
  # Optimize RLS policies and consolidate content access rules

  1. Changes
    - Consolidate content access policies
    - Optimize RLS for better performance
    - Fix profile and storage access issues

  2. Security
    - Enable RLS on all tables
    - Add optimized policies for content access
