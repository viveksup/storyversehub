...
DO $$ 
BEGIN
  -- Drop story_categories policies
  ...
  -- Drop user_story_interactions policies
...
DROP TRIGGER IF EXISTS update_story_analytics_trigger ON user_story_interactions;
