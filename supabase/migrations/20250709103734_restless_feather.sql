/*
  ...
  This migration addresses multiple database schema issues:

  1. Missing Tables
     - `user_activities` - Track user activities and interactions
     - `user_presence` - Track user online status and typing indicators
     - `conversations` - Direct messaging conversations
     - `message_notifications` - Message notification system
     - `reading_sessions` - Track reading sessions
  ...
  4. Foreign Key Relationships
     - Add proper foreign keys for conversations and message notifications
