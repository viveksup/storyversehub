/*
  # Create Stories System with Real-time Data

  1. New Tables
    - `story_categories` - Story categories with metadata
    - `stories` - Enhanced stories table with full metadata
    - `story_tags` - Story tagging system
